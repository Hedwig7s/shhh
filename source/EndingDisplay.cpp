...
EndingDisplay::EndingDisplay() {
    ...
    SetTime(0);
    gameName.SetText("CTGP 6");
    gameName.SetScale(Vector2(2.f/3.f, 2.f/3.f));
    gameName.SetPosition(Vector3(0.f, 75.f, 0.1f));
    gameName.CenterH(false);
    gameName.SetColor(Color(0.75f, 0.75f, 0.75f), true);
    version.SetText("(3DS v0.2)");
    version.SetScale(Vector2(1.5f/3.f, 1.5f/3.f));
    version.SetPosition(Vector3(0.f, 95.f, 0.1f));
    version.CenterH(false);
    version.SetColor(Color(0.75f, 0.75f, 0.75f), true);
    credits.SetText("by PabloMK7");
    credits.SetScale(Vector2(1.5f/3.f, 1.5f/3.f));
    credits.SetPosition(Vector3(0.f, 110.f, 0.1f));
    ...
    pressToExit.SetPosition(Vector3(0.f, 145.f, 0.1f));
